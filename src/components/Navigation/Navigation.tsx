          ...
          {item.children?.map((i, index) => (
            ...
            >
              <NavLink
                ...
                strict
                to={i.link}
                className="block px-4 py-3 hover:bg-gray-100 uppercase font-bold tracking-wider"
    ...
    return (
      ...
      >
        <NavLink
          exact
          strict
          className={`inline-flex items-center py-2 px-3 xl:px-4 text-link-small xl:text-link-medium font-bold uppercase tracking-wider`}
          to={item.link}
          activeClassName="text-primary"
        >
          {item.name}
    ...
    <div>
      <div className="block lg:hidden">
        ...
        <div
          ...
          id={navMobileId}
        >
          <NavMobile data={DATA} modalId={navMobileId} />
        </div>
        <div
